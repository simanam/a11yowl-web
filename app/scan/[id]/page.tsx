    ...
    <>
      ...
      <main id="main-content">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
          ...
          {/* Scoring Disclaimer */}
          <div className="max-w-2xl mx-auto mb-6 p-4 rounded-xl bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800">
            <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
              <strong className="text-slate-600 dark:text-slate-300">Disclaimer:</strong> These scores are generated by automated AI-powered analysis and may not capture every accessibility issue. Results can vary between scans. This report is for informational purposes only and does not constitute legal advice. For full WCAG compliance assurance, we recommend a professional manual audit. Questions? Contact us at{" "}
