    ...
    <>
      ...
      <main id="main-content" className="py-24">
        <div className="max-w-3xl mx-auto px-6">
          <h1 className="text-3xl sm:text-4xl font-extrabold text-center text-slate-900 dark:text-white mb-4">
            Contact Us
          </h1>
          <p className="text-center text-slate-500 dark:text-slate-400 max-w-lg mx-auto mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
            ...
            <div className="p-8 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 text-sm font-medium text-owl-accent hover:underline"
              >
